...
export default function PayerStage5() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <StageHeader title="Payer • Stage 5: Review & Sign-off (Payer view)" />

        <Card className="rounded-3xl mb-6">
          <CardContent className="py-8 text-center text-slate-600 dark:text-slate-300">
            <p>Payer-focused visualizations and actions for stage 5 go here.</p>
            <p className="mt-2 text-sm">
              Final contract review, approval workflows, and digital signature
              integration.
            </p>
          </CardContent>
        </Card>
