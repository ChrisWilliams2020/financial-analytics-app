...
export default function PayerStage4() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
        <StageHeader title="Payer • Stage 4: Negotiation & Drafting (Payer view)" />

        <Card className="rounded-3xl mb-6">
          <CardContent className="py-8 text-center text-slate-600 dark:text-slate-300">
            <p>Payer-focused visualizations and actions for stage 4 go here.</p>
            <p className="mt-2 text-sm">
              Contract negotiation workflows, rate setting tools, and automated
              drafting features.
            </p>
          </CardContent>
        </Card>
